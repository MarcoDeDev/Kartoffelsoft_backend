    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/artikel/register").permitAll()
                        .requestMatchers("/api/artikel").permitAll()
                        .requestMatchers("/api/lieferant/register").permitAll()
                        .requestMatchers("/api/lieferant").permitAll()
                        .requestMatchers("/api/grosskunde/register").permitAll()
                        .requestMatchers("/api/grosskunde").permitAll()
